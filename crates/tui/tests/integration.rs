...
async fn test_sse_connect_receives_events() {
    ...
    assert!(matches!(events[0], tui::client::model::ServerEvent::TextDelta { .. }));
    assert!(matches!(events[1], tui::client::model::ServerEvent::TurnEnd { .. }));
...
fn test_keybinding_parse_all_valid_keys() {
    ...
    let keys = vec![
        ...
        "editor.page_up", "editor.page_down",
        "editor.delete_char_backward", "editor.delete_char_forward",
        "editor.delete_word_backward", "editor.delete_word_forward",
        "editor.delete_to_line_start", "editor.delete_to_line_end",
        "editor.new_line", "editor.submit", "editor.undo",
        "editor.yank", "editor.yank_pop",
