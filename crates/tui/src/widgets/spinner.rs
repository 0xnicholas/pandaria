...
impl SpinnerWidget {
    pub fn new() -> Self { Self { frame_index: 0 } }
    pub fn tick(&mut self) { self.frame_index = (self.frame_index + 1) % SPINNER_FRAMES.len(); }
    pub fn interval_ms() -> u64 { SPINNER_INTERVAL_MS }
...
mod tests {
    ...
    fn test_spinner_cycles() {
        ...
        for _ in 0..SPINNER_FRAMES.len() { s.tick(); }
